...
## Demo 
The demo video shows the example where the goal is to open the automatic door by setting the WoT property ```voltageOutput``` of the power supply to 5 volts and invoking the ```open``` WoT action on the door controller.
